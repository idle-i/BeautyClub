...
object FirebaseConstants {
    const val servicesCollection: String = "services"
    const val categoriesCollection: String = "categories"
    ...
    const val masterIdField: String = "masterId"
    const val servicesField: String = "services"
    const val cityField: String = "city"
    const val timeField: String = "time"
    const val canceledField: String = "canceled"
    const val categoryField: String = "category"
}